    ...
    return(
        ...
        <div className='mb-20'>
            <motion.div  initial={{opacity: 0, y: 40}}
             ...
             <div className="p-2 md:p-10 flex gap-10 sm:mb-1 items-center justify-around flex-col lg:flex-row lg:gap-10 mt-10 lg:mt-4">
                 <motion.div initial={{opacity: 0, y: 70}}
                             whileInView={{opacity: 1, y:0}}
                             transition={{duration: 1.5}}
                             viewport={{once: true}}
                             className="container flex flex-col items-center justify-center shadow-md hover:shadow-2xl rounded-sm w-4/5 gap-4 p-6 ">
                 ...
                 <motion.div initial={{opacity: 0, y: 160}}
                     ...
                     traditional fermented yirgacheffe flavors and creates a lighter bodied coffee bean with citrus and floral notes.</p>
                 </motion.div>
             </div>
        </div>
        </>
