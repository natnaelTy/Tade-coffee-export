...
function About(){
    return(
        ...
        <div className="bg-yellow-100 relative">
            <div className="grid p-10 items-center justify-center gap-8 lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1 min-h-screen">
               <motion.div initial={{opacity: 0, y: 60}}
                   ...
                   <p className="text-xl uppercase text-yellow-700 ">About</p>
