                  ...
                  <div onClick={handlePrevious} className="arrow arrowLeft"><MdOutlineArrowBackIosNew/></div>
                    {
                     ...
                     images.map((imageList, index) => (
                        <img key={imageList.id} src={imageList.images} alt="" className={currentSlide === index ? 'currentImage h-[450px] w-full object-cover rounded-sm shadow-sm' : 'currentImage hide-image' }/>
                     ))
                     : null
                    }
